/**
 * Stable, deterministic image selection helper for Agro Stores.
 * Maps store IDs to a realistic agricultural store photo.
 */

const DEFAULT_STORE_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="800" height="500" viewBox="0 0 800 500"><rect width="100%" height="100%" fill="%231b4332"/><g fill="%232d6a4f"><path d="M0 350 L800 250 L800 500 L0 500 Z"/><circle cx="650" cy="150" r="80" fill="%2340916c" opacity="0.3"/></g><text x="50%" y="45%" dominant-baseline="middle" text-anchor="middle" font-family="sans-serif" font-size="32" font-weight="900" fill="%23d8f3dc">🌿 RAITHASETU AGRO STORE</text><text x="50%" y="58%" dominant-baseline="middle" text-anchor="middle" font-family="sans-serif" font-size="18" font-weight="600" fill="%23b7e4c7">Quality Seeds • Fertilizers • Farming Tools</text></svg>`;

const FALLBACK_AGRO_STORE_IMAGES = [
...
function getStoreImage(storeId, customImage) {
